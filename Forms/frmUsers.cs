    ...
    public partial class frmUsers
        ...
        private void Backup_eLib ()
            ...
            if (Db.BackupRegister == 0)
                ...
                Db.strSQL = "SELECT ID, Course_ID, Topic FROM CourseTopics";
                Db.CnnSS.Open ();
                Db.DASS = new Microsoft.Data.SqlClient.SqlDataAdapter (Db.strSQL, Db.CnnSS);
                ...
                Db.strSQL = "SELECT ID, TestText, TestType, Course_ID, Topic_ID, TestRTL, OptionsRTL, TestLevel FROM Tests";
                Db.CnnSS.Open ();
                Db.DASS = new Microsoft.Data.SqlClient.SqlDataAdapter (Db.strSQL, Db.CnnSS);
                ...
                Db.strSQL = "SELECT ID, Test_ID, OptionText, IsAnswer, ForceLast FROM TestOptions";
                Db.CnnSS.Open ();
                Db.DASS = new Microsoft.Data.SqlClient.SqlDataAdapter (Db.strSQL, Db.CnnSS);
                ...
                Db.strSQL = "SELECT ID, Course_ID, ExamTitle, ExamDateTime, ExamDuration, ExamNTests, ExamShuffleOptions, IsActive, Training FROM Exams";
                Db.CnnSS.Open ();
                Db.DASS = new Microsoft.Data.SqlClient.SqlDataAdapter (Db.strSQL, Db.CnnSS);
                ...
                Db.strSQL = "Select ExamComposition.ID, Exam_ID, Topic_ID, Topic, TopicNTests, TestsLevel FROM ExamComposition INNER JOIN CourseTopics ON ExamComposition.Topic_ID = CourseTopics.ID";
                Db.CnnSS.Open ();
                Db.DASS = new Microsoft.Data.SqlClient.SqlDataAdapter (Db.strSQL, Db.CnnSS);
                ...
                Db.strSQL = "Select ID, Entry_ID, ParticipantName, ParticipantPass FROM Participants";
                Db.CnnSS.Open ();
                Db.DASS = new Microsoft.Data.SqlClient.SqlDataAdapter (Db.strSQL, Db.CnnSS);
        ...
        private void Restore_eLib ()
            ...
            try
                ...
                Db.DASS.Fill (Db.DS, "tblNoteNet");
                //8 tblCourses
                Db.DASS = new Microsoft.Data.SqlClient.SqlDataAdapter ("SELECT ID, CourseName, CourseUnits, User_ID, RTL FROM Courses WHERE ID = 0;", Db.CnnSS);
                Db.DASS.Fill (Db.DS, "tblCourses");
                //9 tblCourseTopics
                Db.DASS = new Microsoft.Data.SqlClient.SqlDataAdapter ("SELECT ID, Course_ID, Topic FROM CourseTopics WHERE ID = 0;", Db.CnnSS);
                Db.DASS.Fill (Db.DS, "tblCourseTopics");
                //10 tblTests
                Db.DASS = new Microsoft.Data.SqlClient.SqlDataAdapter ("SELECT ID, TestText, TestType, Course_ID, Topic_ID, TestRTL, OptionsRTL, TestLevel FROM Tests WHERE ID = 0;", Db.CnnSS);
                Db.DASS.Fill (Db.DS, "tblTests");
                //11 tblTestOptions
                Db.DASS = new Microsoft.Data.SqlClient.SqlDataAdapter ("SELECT ID, Test_ID, OptionText, IsAnswer, ForceLast FROM TestOptions WHERE ID = 0;", Db.CnnSS);
                Db.DASS.Fill (Db.DS, "tblTestOptions");
                //12 tblExams
                Db.DASS = new Microsoft.Data.SqlClient.SqlDataAdapter ("SELECT ID, Course_ID, ExamTitle, ExamDateTime, ExamDuration, ExamNTests, ExamShuffleOptions, IsActive, Training FROM Exams WHERE ID = 0;", Db.CnnSS);
                Db.DASS.Fill (Db.DS, "tblExams");
                //13 tblExamComposition
                Db.DASS = new Microsoft.Data.SqlClient.SqlDataAdapter ("Select ExamComposition.ID, Exam_ID, Topic_ID, Topic, TopicNTests, TestsLevel FROM ExamComposition INNER JOIN CourseTopics ON ExamComposition.Topic_ID = CourseTopics.ID WHERE ExamComposition.ID = 0;", Db.CnnSS);
                Db.DASS.Fill (Db.DS, "tblExamComposition");
                //14 tblEntries
                Db.DASS = new Microsoft.Data.SqlClient.SqlDataAdapter ("Select ID, EntryName, User_ID FROM Entries WHERE ID = 0;", Db.CnnSS);
                Db.DASS.Fill (Db.DS, "tblEntries");
                //15 tblEntryParticipants
                Db.DASS = new Microsoft.Data.SqlClient.SqlDataAdapter ("SELECT ID, Entry_ID, ParticipantName, ParticipantPass FROM Participants WHERE ID = 0;", Db.CnnSS);
                Db.DASS.Fill (Db.DS, "tblEntryParticipants");
                //------------------------------------------------------------------ C
            ...
            try
                ...
                for (int r = 0; r < Db.DS.Tables ["tblCourseTopics"].Rows.Count; r++)
                    ...
                    Db.strSQL = "INSERT INTO CourseTopics (ID, Course_ID, Topic) VALUES (@id, @courseid, @topic)";
                    var cmd = new Microsoft.Data.SqlClient.SqlCommand (Db.strSQL, Db.CnnSS);
                    cmd.CommandType = CommandType.Text;
            ...
            try
                ...
                for (int r = 0; r < Db.DS.Tables ["tblTests"].Rows.Count; r++)
                    ...
                    testText = Db.DS.Tables ["tblTests"].Rows [r] [1].ToString ();
                    ...
                    Db.strSQL = "INSERT INTO Tests (ID, TestText, TestType, Course_ID, Topic_ID, TestRTL, OptionsRTL, TestLevel) VALUES (@id, @testtext, @testtype, @courseid, @topicid, @testrtl, @optionsrtl, @testlevel)";
                    var cmd = new Microsoft.Data.SqlClient.SqlCommand (Db.strSQL, Db.CnnSS);
                    cmd.CommandType = CommandType.Text;
            ...
            try
                ...
                string examDuration = "";
                int examNTests = 0;
                bool examShuffleOpts = false;
                bool examIsActive = false;
                bool examTraining = false;
                progressBar1.Value = 0;
                ...
                for (int r = 0; r < Db.DS.Tables ["tblExams"].Rows.Count; r++)
                    ...
                    examShuffleOpts = Convert.ToBoolean (Db.DS.Tables ["tblExams"].Rows [r] [6].ToString ());
                    examIsActive = Convert.ToBoolean (Db.DS.Tables ["tblExams"].Rows [r] [7].ToString ());
                    examTraining = Convert.ToBoolean (Db.DS.Tables ["tblExams"].Rows [r] [8].ToString ());
                    Db.strSQL = "INSERT INTO Exams (ID, Course_ID, ExamTitle, ExamDateTime, ExamDuration, ExamNTests, ExamShuffleOptions, IsActive, Training) VALUES (@id, @courseid, @examtitle, @examdatetime, @examduration, @examntests, @examshuffleOpts, @isactive, @training)";
                    var cmd = new Microsoft.Data.SqlClient.SqlCommand (Db.strSQL, Db.CnnSS);
                    cmd.CommandType = CommandType.Text;
                    ...
                    cmd.Parameters.AddWithValue ("@examshuffleOpts", examShuffleOpts.ToString ());
                    cmd.Parameters.AddWithValue ("@isactive", examIsActive.ToString ());
                    cmd.Parameters.AddWithValue ("@training", examTraining.ToString ());
                    int i = cmd.ExecuteNonQuery ();
                    }
                }
            catch (Exception ex)
            ...
            try
                ...
                for (int r = 0; r < Db.DS.Tables ["tblExamComposition"].Rows.Count; r++)
                    ...
                    Db.strSQL = "INSERT INTO ExamComposition (ID, Exam_ID, Topic_ID, TopicNTests, TestsLevel) VALUES (@id, @examid, @topicid, @topicntests, @testslevel)";
                    var cmd = new Microsoft.Data.SqlClient.SqlCommand (Db.strSQL, Db.CnnSS);
                    cmd.CommandType = CommandType.Text;
            ...
            Application.DoEvents ();
            //-------------------------------------------------------------------------- Restore -- xml -------- 15 EntryParticipants
            progressBar2.Value = 16;
            lblInfo.Text = "Restore Entry-Participants";
            try
                {
                Db.strSQL = "SET IDENTITY_INSERT Participants ON";
                var cmd = new Microsoft.Data.SqlClient.SqlCommand (Db.strSQL, Db.CnnSS);
                cmd.CommandType = CommandType.Text;
                int i = cmd.ExecuteNonQuery ();
                }
            ...
            try
                ...
                string participantPass = "";
                progressBar1.Value = 0;
                progressBar1.Maximum = Db.DS.Tables ["tblEntryParticipants"].Rows.Count;
                for (int r = 0; r < Db.DS.Tables ["tblEntryParticipants"].Rows.Count; r++)
                    ...
                    entryID = Convert.ToInt32 (Db.DS.Tables ["tblEntryParticipants"].Rows [r] [1].ToString ());
                    participantName = Db.DS.Tables ["tblEntryParticipants"].Rows [r] [2].ToString ();
                    participantPass = Db.DS.Tables ["tblEntryParticipants"].Rows [r] [3].ToString ();
                    Db.strSQL = "INSERT INTO Participants (ID, Entry_ID, ParticipantName, ParticipantPass) VALUES (@id, @entryid, @participantname, @participantpass)";
                    var cmd = new Microsoft.Data.SqlClient.SqlCommand (Db.strSQL, Db.CnnSS);
                    cmd.CommandType = CommandType.Text;
                    cmd.Parameters.AddWithValue ("id", participantID.ToString ());
            ...
            try
                {
                Db.strSQL = "SET IDENTITY_INSERT Participants OFF";
                var cmd = new Microsoft.Data.SqlClient.SqlCommand (Db.strSQL, Db.CnnSS);
                cmd.CommandType = CommandType.Text;
                int i = cmd.ExecuteNonQuery ();
                }
